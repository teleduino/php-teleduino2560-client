<?php
/*
  _config.php - Teleduino2560 PHP config example
  Version 0.1.2
...
// If you're using the Teleduino2560EthernetServerWeb sketch, set the IP
$config['ethernet_server_web'] = array();
$config['ethernet_server_web']['address'] = 'http://192.168.1.100';

// If you're using the Teleduino2560EthernetClientProxy sketch, set the key
